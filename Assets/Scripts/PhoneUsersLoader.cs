...
public class PhoneUsersLoader{
    ...
    public PhoneUsersLoader () 
    {
        ...
        {
            var user = new PhoneUser(userKey, System.Convert.ToInt32(json[userKey]["id"].f));
            users.Add(user);
